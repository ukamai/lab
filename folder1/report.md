...
Цель работы: Создать и подключить репозиторий
...
```
Выводы: я изучил как работает github и считаю, что умение с ним работать поможет мне в дальнейшем обучение и в будущей работы. 
